...
class BookingInfo {
  ...
  List<BookingInfo>? subBooking = [];
  List<String> subRequest = [];
  List<ClassReview> subReview = [];
  ...
  BookingInfo.fromJson(Map<String, dynamic> json) {
    ...
    subBooking = json["subBooking"] != null ? json["subBooking"].cast<BookingInfo>() : [];
    classReview = json['classReview'] != null ? ClassReview.fromJson(json['classReview']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['subBooking'] = subBooking;
    data['classReview'] = classReview !=null ? classReview!.toJson() : null;
    return data;
  }
}